          ...
          <div className="px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-1 items-center">
                ...
                <a
                  href="#"
                  className="items-center rounded-md bg-white px-19.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Sign up
                </a>
              </div>
