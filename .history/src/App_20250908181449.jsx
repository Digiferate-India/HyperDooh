        ...
        <header className="absolute inset-x-0 top-0 z-50">
          <div className="px-1 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="mr-5.5 hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-4 items-center">
                <a
                  href="#"
                  className="text-sm font-semibold leading-6 text-white hover:text-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Sign in
                </a>
                <a
