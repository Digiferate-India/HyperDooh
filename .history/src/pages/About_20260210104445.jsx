...
import { AboutCarousel } from '../components/AboutCarousel'; // Imports the carousel
...
const teamMembers = [
  ...
  },
  {
    ...
    imageUrl: "https://i.postimg.cc/pL9c10GY/1516429462474.jpg",
    description:
    ...
    linkedin: "https://www.linkedin.com/in/mahinder-t-4a08a02b/",
    eco: false,
  },
];

const digitalSignageBenefits = [
  {
    title: "Increased Engagement",
    description: "Bright displays and interactive features capture attention, reduce perceived wait times, and boost impulse purchases.",
    icon: "👁️"
  },
  {
    title: "Cost Efficiency",
    description: "Reduces recurring printing expenses and allows real-time content updates.",
    icon: "💰"
  },
  {
    title: "Personalized Experience",
    description: "AI-driven signages can analyze demographics and environmental data to display relevant content, improving marketing ROI.",
    icon: "🎯"
  },
  {
    title: "Brand Consistency",
    description: "Centralized cloud CMS supports remote content updates across multiple locations, ensuring uniform messaging.",
    icon: "🔄"
  }
];
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-indigo-400 mb-4">
              Digital Signage: Transforming Modern Communication
            </h2>
            <p className="text-xl text-black max-w-4xl mx-auto">
              Digital signage is revolutionizing communication and advertising for businesses worldwide. Leveraging dynamic displays and real-time content management, digital signages enhance customer engagement, drive brand visibility, and boost sales across industries.
            </p>
          </div>
          ...
          <div className="mb-12">
            <h3 className="text-2xl font-bold text-indigo-400 mb-6 text-center">Key Benefits of Digital Signage</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {digitalSignageBenefits.map((benefit, index) => (
                <div key={index} className="bg-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
          ...
          <div className="mb-12">
            <h3 className="text-2xl font-bold text-indigo-400 mb-6 text-center">Latest Technologies</h3>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-gray-800 rounded-2xl p-8 shadow-lg border-l-4 border-indigo-500">
                <h4 className="text-xl font-bold text-white mb-4">The Challenge with Legacy CMS</h4>
                <p className="text-gray-300 leading-relaxed">
                  Digital signages today often play non-relevant content and lack the ability to provide critical emergency messaging. Current CMS systems are limited to basic looping and scheduling, failing to react to the world around them.
                </p>
              </div>
              <div className="bg-gray-800 rounded-2xl p-8 shadow-lg border-l-4 border-indigo-500">
                <h4 className="text-xl font-bold text-white mb-4">HyperDOOH: Real-Time Intelligence</h4>
                <p className="text-gray-300 leading-relaxed">
                  HyperDOOH involves the usage of cameras and environmental sensors to trigger content onto digital signages in real time <span className="text-indigo-400 font-semibold">(Patent Pending)</span>. Unlike reactive legacy systems, our proposed solution serves a dual-purpose: a powerful advertising system that instantly transitions into a public safety messaging system during emergencies.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="w-full py-16 bg-white">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center w-full">
            ...
            <div className="mt-9 lg:mt-0 w-full">
              <div className="rounded-2xl overflow-hidden shadow-2xl w-full">
                <img
                  className="w-full h-84 object-cover"
                  src="https://www.pickcel.com/assets/img/ogg/what-is-digital-signage-fb.jpg"
