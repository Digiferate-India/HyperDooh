...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen w-screen font-sans">
      <div className="hidden md:flex flex-1 items-center justify-center text-white p-12 bg-cover bg-center" style={{ backgroundImage: "url('https://i.postimg.cc/m2cVY7Zn/gradient-wallpapers-5-Q9-Gf0-WSy-Lk-unsplash.jpg')" }} > <div className="relative w-full max-w-md"> <div className="bg-black/40 backdrop-blur-md rounded-3xl p-10 border border-white/20"> <h1 className="text-xl font-semibold">HyperDooh</h1> <p className="mt-10 text-4xl font-bold leading-snug"> Reach your audience, Bold and fearless with specialized audience targeting options. </p> <div className="flex mt-8 space-x-2"> <span className="w-3 h-3 bg-white/50 rounded-full"></span> <span className="w-3 h-3 bg-white/50 rounded-full"></span> <span className="w-3 h-3 bg-white rounded-full"></span> </div> </div> </div> </div>
      {/* Right Side */}
