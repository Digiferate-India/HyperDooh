      ...
      <div className="mt-20">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 max-w-7xl mx-auto">
            <div className="feature-card bg-white/3 rounded-2xl p-8 shadow-xl">
              ...
              <div className="mt-6 -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <img
                  src="https://i.postimg.cc/52zXh3pZ/Gemini-Generated-Image-w59m9ew59m9ew59m.png"
                  alt="Feature 1"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="feature-card bg-white/3 rounded-2xl p-8 shadow-xl text-center">
                <h3 className="text-xl text-black font-bold text-center">
                  Lightning fast
                </h3>
