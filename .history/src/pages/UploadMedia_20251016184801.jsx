    ...
    <div>
      ...
      {isLoadingList ? (
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
          {mediaFiles.map((file) => (
            <div key={file.id} style={{ border: '1px solid #ccc', padding: '0.5rem', borderRadius: '8px' }}>
              {file.file_type.includes('image') ? (
                <img src={file.file_path} alt={file.file_name} style={{ width: '150px', height: '150px', objectFit: 'cover' }} />
              ) : (
                <video src={file.file_path} style={{ width: '150px', height: '150px', backgroundColor: 'black' }} />
              )}
