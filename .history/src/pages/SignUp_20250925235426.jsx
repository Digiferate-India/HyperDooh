...
const SignUp = () => {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Side */}
      <div className="hidden md:flex flex-1 bg-gradient-to-br from-purple-900 via-purple-700 to-indigo-700 items-center justify-center text-white p-12">
      ...
      {/* Right Side */}
      <div className="flex justify-center items-center w-full md:w-1/2 lg:max-w-lg bg-white px-8 py-12">
        <div className="w-full max-w-sm">
          <div className="flex justify-end space-x-6 text-sm mb-6">
            <a href="#" className="text-blue-600 font-medium border-b-2 border-blue-600">Sign up</a>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-5">
            ...
            <p className="text-xs text-gray-500">
              By signing up you agree to <a href="#" className="text-blue-600 underline">terms and conditions</a> at zoho.
            </p>
            <button type="submit" className="w-full py-2 text-white bg-blue-900 rounded-md font-semibold hover:bg-blue-800">
              Register
            </button>
          </form>
