      ...
      <div className="w-full py-20 px-4 sm:px-6 lg:px-8">
        <div className="w-full text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            To enable governments and event organizations prevent disasters with safety and warning messages.
To help businesses monetize to the maximum extent using Real time Digital Signage promotions.
