    ...
    <div className="bg-gray-900 text-white min-h-screen w-full">
      ...
      <div className="w-full py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base font-semibold text-indigo-400 sm:text-11xl tracking-wide uppercase">About Us</h2>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center w-full">
            ...
            <div className="mt-8 lg:mt-0 w-full">
              <img 
                ...
                src="https://images.unsplash.com/photo-1549641775-10a1b5059535?q=80&w=1932"
