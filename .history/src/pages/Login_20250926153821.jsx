...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen w-screen font-sans">
      {/* Left Side */}
      <div className="hidden md:flex flex-1 bg-[#1a0044] items-center justify-center text-white p-12">
        <div className="relative w-full max-w-md">
            <div className="absolute -z-10 top-1/2 left-1/2 w-[550px] h-[550px] bg-gradient-to-br from-purple-600 to-indigo-800 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl opacity-30"></div>
      ...
      <div className="flex justify-center items-center flex-1 bg-white px-8 py-12">
        <div className="w-full max-w-sm">
          <div className="flex justify-end space-x-6 text-sm mb-12">
            <a href="#" className="text-gray-700 font-medium">Sign up</a>
            <a href="#" className="text-blue-600 font-bold border-b-2 border-blue-600 pb-1">Login</a>
          </div>
