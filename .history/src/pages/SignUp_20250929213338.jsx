...
const SignUp = () => {
  ...
  return (
    <div className="flex min-h-screen w-full">
      {/* Left Side */}
      <div className="hidden md:flex flex-1 h-screen bg-[url('https://i.postimg.cc/m2cVY7Zn/gradient-wallpapers-5-Q9-Gf0-WSy-Lk-unsplash.jpg')] bg-cover bg-center items-center justify-center text-white p-12">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-5">
            ...
            <p className="text-xs text-gray-500">
              ...
              <a href="#" className="text-blue-600 underline">terms and conditions</a> at zoho.
            </p>
            <button type="submit" className="w-full py-2 text-white bg-blue-900 rounded-md font-semibold hover:bg-blue-800 transition">
              Register
            </button>
          </form>
