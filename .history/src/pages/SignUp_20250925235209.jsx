...
const SignUp = () => {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Side */}
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-900 via-purple-700 to-indigo-700 items-center justify-center text-white p-12 relative">
      ...
      {/* Right Side */}
      <div className="flex flex-col justify-center w-full md:w-1/2 bg-white px-8 py-12">
