...
// --- MediaFile component (no change from last time) ---
...
// This component will hold the folder and its delete button
function FolderCard({ folder, onClick, onFolderDelete }) {

  const handleDeleteClick = (e) => {
    // This stops the click from also triggering the 'onClick' for opening the folder
    e.stopPropagation(); 
  ...
  return (
    <div
      onClick={onClick} // This is the function to open the folder
      style={{
        padding: "0.5rem",
        borderRadius: "8px",
        textAlign: "center",
...
function UploadMedia() {
  ...
  // ✅ --- NEW: Function to delete a folder ---
  ...
  return (
    <div className="p-6 bg-white text-gray-900 min-h-screen">
      ...
      {/* ✅ --- Display Folders (UPDATED) --- */}
      <h2>Your Folders</h2>
      {isLoadingList ? (
        <p>Loading...</p>
      ) : (
        <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem" }}>
          {/* Use the new FolderCard component */}
          {folders.map((folder) => (
            <FolderCard
              key={folder.id}
              folder={folder}
