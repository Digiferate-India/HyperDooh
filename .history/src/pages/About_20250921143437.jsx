...
const teamMembers = [
  ...
  },
  {
    ...
    description:
      "Powerful AI tools for better site design. Direct access to key creative elements and promotions.",
    linkedin: "#",
    founded: "2019",
    eco: true,
  },
  {
    ...
    description:
      "We have smartphones that address and layered agency models to give you direct access to creative solutions.",
    linkedin: "#",
    founded: "2020",
    eco: false,
  },
      ...
      <div className="w-full py-20 px-4 sm:px-6 lg:px-8">
        <div className="w-full text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            To enable governments and event organizations prevent disasters with
            safety and warning messages. To help businesses monetize to the
            maximum extent using Real time Digital Signage promotions.
          </p>
        </div>
      </div>
