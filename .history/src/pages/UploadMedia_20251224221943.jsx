...
function UploadMedia() {
  ...
  const handleFileDelete = async (file) => {
    try {
      ...
      if (file.thumbnail_path) {
        ...
        if (thumbStorageError) console.error("Error deleting thumbnail:", thumbStorageError.message);
      }
      ...
      <div className="p-6 bg-white text-gray-900 min-h-screen">
        <button
          onClick={() => {
            ...
            setSelectedFile(null); // Clear selection when going back
          }}
        ...
        >
          ...
          {/* ✅ ADDED: Display selected file name inside folder view */}
          {selectedFile && (
  ...
  return (
    <div className="p-6 bg-white text-gray-900 min-h-screen">
      ...
      {/* Existing file name display for root view */}
      {selectedFile && (
        <p style={{ marginTop: "1rem", fontWeight: "bold", color: "#333" }}>
          Selected: {selectedFile.name}
        </p>
          ...
          {folders.map((folder) => (
            <FolderCard
              ...
              onClick={() => {
                ...
                setSelectedFile(null); // Clear previous selection when entering folder
              }}
