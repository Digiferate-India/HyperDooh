    ...
    async function getDashboardData() {
      try {
        ...
        allFaces.forEach(face => {
            // ✅ SKIP DUPLICATES: Only count unique people for Age Data
        ...
        allFaces.forEach(face => {
            // ✅ SKIP DUPLICATES: Only count unique people for Gender Data
            if (!face.is_new) return;
        ...
        // Calculate Total Impressions (Unique Faces only)
        const totalImpressions = allFaces.filter(face => face.is_new).length;
        
        // Calculate Avg Age (Unique Faces only)
        ...
        // NOTE: We do NOT filter the table. The table shows the raw log stream (including tracking updates).
