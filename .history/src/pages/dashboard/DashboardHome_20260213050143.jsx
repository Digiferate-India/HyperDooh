    ...
    async function getDashboardData() {
      try {
        ...
        if (screenIds.length > 0) {
          ...
          // 🚀 FIX: Increased .limit() to 1000 to reach the Dec 2025 records
        ...
        allFaces.forEach(face => {
            // ✅ SKIP DUPLICATES: Only count unique people
        ...
        allFaces.forEach(face => {
            ...
            // 🔍 DEBUG LOG: Check if the female record is actually being processed
            console.log(`Processing unique visitor: ${face.gender} (${face.created_at})`);
