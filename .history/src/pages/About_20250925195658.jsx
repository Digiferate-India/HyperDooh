...
const technologies = [
  ...
  { name: "Cloud-Based Management", description: "Facilitates seamless, remote content distribution and scalability." }
];
      ...
      <div className="w-full py-16 bg-white">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="bg-white-light rounded-2xl p-6 shadow-lg">
