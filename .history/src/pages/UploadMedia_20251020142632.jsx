...
function MediaFile({ file, folders, onFileMove }) {
  ...
  return (
    ...
    >
      ...
      {/* ✅ --- "Move to" Dropdown (Style Updated) --- */}
      <select 
        onChange={handleMove} 
        style={{ 
          width: "100%", 
          ...
          padding: "4px" // A little padding helps
        }}
      >
  ...
  return (
    ...
    <div className="p-6 bg-white text-gray-900 min-h-screen">
      ...
      <button
        ...
        style={{
          backgroundColor: !selectedFile || isUploading ? "#ccc" : "#007bff",
          color: "#fff", // ✅ Added color for light mode
          padding: "8px 16px", // ✅ Added padding
          border: "none", // ✅ Added border
          borderRadius: "6px", // ✅ Added borderRadius
      ...
      {/* --- Media Library (unassigned) (no change) --- */}
