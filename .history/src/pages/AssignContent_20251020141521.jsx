        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="border-2 border-gray-600 focus:border-blue-400 p-2 rounded-lg bg-transparent text-white outline-none transition-colors duration-200 " // Added text-black here too
              required
            />
          </div>
