...
const teamMembers = [
  { 
    ...
    description: 'Design your store, your way — without coding. Smart solutions that address layered agency models.',
    linkedin: '#',
    founded: '2018',
    eco: true
  },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member) => (
              <div key={member.name} className="bg-gray-800 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                {/* Member Header */}
                ...
                {/* Description */}
                <p className="text-gray-300 text-sm mb-6 leading-relaxed border-l-2 border-indigo-500 pl-4">
                  "{member.description}"
                </p>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-xs text-gray-400">14:17 • 21-09-2023</span>
                </div>
