      ...
      <div className="relative isolate bg-black text-white">
        ...
        <header className="absolute inset-x-0 top-0 z-50">
          <div className="px-4 sm:px-6 lg:px-8">
            <nav
              className="flex items-center justify-between py-2 w-screen mx-auto bg-amber-50"
              aria-label="Global"
            >
              ...
              <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-1 items-center">
                <a
                  href="#"
                ...
                <a
                  href="#"
                  className="items-center mr-1.5 rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Sign up
                </a>
              </div>
          ...
          <div className="mt-19 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <img
                  src="https://i.postimg.cc/1z0Cs288/Dashboard-Overview.png"
                  alt="App screenshot"
