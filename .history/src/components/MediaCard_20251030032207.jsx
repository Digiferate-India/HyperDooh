          ...
          {!isAssigned ? (
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={handleSave}
                disabled={isSaving}
                className="w-full px-9 py-2 rounded text-white font-semibold transition-colors bg-green-600 hover:bg-green-700 disabled:bg-gray-400"
              >
              ...
              <button
                ...
                disabled={isSaving}
                className="w-full mr-1 px-4 py-2 rounded text-white font-semibold transition-colors bg-red-600 hover:bg-red-700 disabled:bg-gray-400"
              >
                Rem
              </button>
            </div>
