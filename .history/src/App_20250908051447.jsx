          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="#"
                  className="rounded-md bg-white px-4 py-3 text-sm uppercase color-black font-semibold text-gray-900 shadow-sm hover:bg-gray-200"
                >
                  Book a Demo
                </a>
              </div>
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <img
                  src="https://i.postimg.cc/TwdJ6TT9/Feature1-UI.png"
                  alt="App screenshot"
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-10 grid grid-cols-2 items-center gap-x-8 gap-y-10 sm:grid-cols-3 lg:grid-cols-6">
              <span className="col-span-1 text-2xl font-bold text-black text-center">
                Zebra
              </span>
              <span className="col-span-1 text-2xl font-bold text-black text-center">
                Mondaze
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="relative aspect-video rounded-xl shadow-2xl overflow-hidden">
              <img
                src="https://placehold.co/1024x576/18181B/FFF?text=Video+Thumbnail"
                alt="Video Thumbnail"
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                <button className="w-20 h-20 bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm border border-white border-opacity-30 transition-transform hover:scale-110">
                  ...
                  >
                    <path
                      d="M6.3 3.75a.75.75 0 011.05 0l7.5 6.25a.75.75 0 010 1.05l-7.5 6.25a.75.75 0 01-1.05-1.05L13.2 10 6.3 4.8a.75.75 0 010-1.05z"
                      clipRule="evenodd"
                    />
                  </svg>
                </button>
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 max-w-7xl mx-auto">
            <div className="bg-white/3 rounded-2xl p-8 shadow-xl">
              <h3 className="text-xl text-black font-bold">Signage Connection</h3>
              ...
              <div className="mt-6 -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <img
                  src="https://i.postimg.cc/N0sFPwtb/Dashboard-Pair.png"
                  alt="Feature 1"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white/3 rounded-2xl p-8 shadow-xl">
                <h3 className="text-xl text-black font-bold">Multiplayer with CV</h3>
                <p className="mt-2 mb-7 text-gray-900">
                ...
                <div className="mt-6 -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <img
                    src="https://i.postimg.cc/447bsj7B/Dashboard-Assign-Content.png"
                    alt="Feature 2"
                    className="rounded-md w-full"
                  />
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-16 grid grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:grid-cols-3">
              ...
              <div className="relative bg-white/5 p-8 rounded-3xl shadow-xl ring-2 ring-indigo-500">
                ...
                <a
                  href="#"
                  className="mt-8 block text-blue-50 rounded-md bg-indigo-500 px-3.5 py-2.5 text-center text-sm font-semibold shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                >
                  Choose plan
                </a>
              </div>
              ...
              <div className="relative bg-white/5 p-8 rounded-3xl shadow-xl ring-1 ring-white/10">
                ...
                <a
                  href="#"
                  className="mt-8 block rounded-md border border-white/20 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-white/10"
                >
                  Choose plan
                </a>
              </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-8">
              <a
                href="#"
                className="inline-flex items-center gap-x-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-200"
              >
                Join Now
