...
const PaperjetLogo = () => (
    <svg width="100" height="24" viewBox="0 0 100 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <text x="0" y="18" fontFamily="Arial, sans-serif" fontSize="20" fontWeight="bold" fill="white">HyperDooh</text>
    </svg>
);
...
const SlackIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-gray-400 hover:text-white"><path d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523A2.528 2.528 0 0 1 0 15.165a2.527 2.527 0 0 1 2.522-2.52h2.52v2.52zM6.313 15.165a2.527 2.527 0 0 1 2.521-2.522h2.522a2.527 2.527 0 0 1 2.521 2.522v6.313A2.527 2.527 0 0 1 11.356 24a2.528 2.528 0 0 1-2.521-2.522v-6.313zM8.834 5.042a2.528 2.528 0 0 1 2.521-2.52A2.528 2.528 0 0 1 13.876 5.042a2.527 2.527 0 0 1-2.521 2.522h-2.521v-2.522zM8.834 6.313a2.527 2.527 0 0 1-2.521 2.521V2.522A2.527 2.527 0 0 1 8.834 0a2.528 2.528 0 0 1 2.521 2.521h6.313A2.528 2.528 0 0 1 20.19 5.042a2.528 2.528 0 0 1-2.522 2.521H8.834zM18.956 8.834a2.528 2.528 0 0 1 2.522-2.521A2.528 2.528 0 0 1 24 8.834a2.527 2.527 0 0 1-2.522 2.521h-2.522V8.834zM17.685 8.834a2.527 2.527 0 0 1-2.522 2.522h-2.521a2.527 2.527 0 0 1-2.522-2.522V2.521A2.527 2.527 0 0 1 12.642 0a2.528 2.528 0 0 1 2.521 2.521v6.313z"></path></svg>;
                    ...
                    <div className="px-4 sm:px-6 lg:px-8">
                        <nav className="flex items-center justify-between py-6 max-w-7xl mx-auto" aria-label="Global">
                            ...
                            <div className="hidden lg:flex lg:gap-x-12">
                                <a href="#" className="text-sm font-semibold leading-6 text-black hover:text-white">Product</a>
                                <a href="#" className="text-sm font-semibold leading-6 text-black hover:text-white">Pricing</a>
                                <a href="#" className="text-sm font-semibold leading-6 text-black hover:text-white">Company</a>
                                <a href="#" className="text-sm font-semibold leading-6 text-black hover:text-white">Blog</a>
                            </div>
                            <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-4 items-center">
                                <a href="#" className="text-sm font-semibold leading-6 text-black hover:text-white">Sign in</a>
            ...
            <div className="bg-color-white mt-20">
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-x-8 gap-y-10 text-center lg:grid-cols-3 max-w-7xl mx-auto">
                        <div>
                            <h3 className="text-4xl font-bold tracking-tight text-black sm:text-5xl">1M+</h3>
                            <p className="mt-2 text-base leading-7 text-gray-400">Audience Interests</p>
                        </div>
                        <div>
                            <h3 className="text-4xl font-bold tracking-tight text-black sm:text-5xl">5K+</h3>
                            <p className="mt-2 text-base leading-7 text-gray-400">Trusted companies</p>
                        </div>
                        <div>
                            <h3 className="text-4xl font-bold tracking-tight text-black sm:text-5xl">200+</h3>
                ...
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="mt-10 grid grid-cols-2 items-center gap-x-8 gap-y-10 sm:grid-cols-3 lg:grid-cols-6">
                            <span className="col-span-1 text-2xl font-bold text-black text-center">Zebra</span>
                            <span className="col-span-1 text-2xl font-bold text-black text-center">Mondaze</span>
                            <span className="col-span-1 text-2xl font-bold text-black text-center">Hexlant</span>
                            <span className="col-span-1 text-2xl font-bold text-black text-center">AIMMO</span>
                            <span className="col-span-1 text-2xl font-bold text-black text-center">SELECT</span>
                            <span className="col-span-1 text-2xl font-bold text-black text-center">Company</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 max-w-7xl mx-auto">
                        <div className="bg-black rounded-2xl p-8 shadow-xl">
                            ...
                            <p className="mt-2 text-gray-400">Easily collaborate with colleagues to quickly solve complex problems,
as well as allow customers to track progress in real time.</p>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div className="bg-black/5 rounded-2xl p-8 shadow-xl">
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="mt-16 grid grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:grid-cols-3">
                            ...
                            <div className="relative bg-white/5 p-8 rounded-3xl shadow-xl ring-2 ring-indigo-500">
                                ...
                                <p className="mt-6 text-base leading-7 text-black">For small teams and startups.</p>
                            ...
                            <div className="relative bg-white/5 p-8 sm:mx-8 lg:mx-0 rounded-3xl shadow-xl ring-1 ring-white/10">
                                <h3 className="text-base font-semibold leading-7 text-black">Business</h3>
                                <p className="mt-4 flex items-baseline gap-x-2">
                                    <span className="text-5xl font-bold tracking-tight text-white">$123</span>
                                    <span className="text-base text-gray-400">/month</span>
                                </p>
                                <p className="mt-6 text-base leading-7 text-black">For growing businesses.</p>
                                <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-black">
                            ...
                            <div className="relative bg-white/5 p-8 rounded-3xl shadow-xl ring-1 ring-white/10">
                                <h3 className="text-base font-semibold leading-7 text-black">Enterprise</h3>
                                <p className="mt-4 flex items-baseline gap-x-2">
                                    <span className="text-5xl font-bold tracking-tight text-white">$252</span>
                                    <span className="text-base text-gray-400">/month</span>
                                </p>
                                <p className="mt-6 text-base leading-7 text-black">For large enterprises.</p>
                                <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-black">
            ...
            <div className="text-center py-16">
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="mt-4 text-lg leading-8 text-black">Join our 1,000,000+ person community and contribute to a more private, Signage-first technology.</p>
                        <div className="mt-8">
                            ...
                            <div className="mt-10 grid grid-cols-2 gap-8 md:grid-cols-4">
                                <div className="md:col-start-2">
                                    ...
                                    <ul role="list" className="mt-6 space-y-4">
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Mail</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Drive</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Chat</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Calendar</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Photos</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Download</a></li>
                                    </ul>
                                </div>
                                <div>
                                    <h3 className="text-sm font-semibold leading-6 text-white">RESOURCES</h3>
                                    <ul role="list" className="mt-6 space-y-4">
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Blog</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Help</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">About us</a></li>
                                        <li><a href="#" className="text-sm leading-6 text-black hover:text-white">Changelog</a></li>
                                    </ul>
                                </div>
                            </div>
