          ...
          <div className="grid grid-cols-1 gap-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white/3 rounded-2xl p-8 shadow-xl">
                ...
                <div className="mt-6 -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <img
                    src="https://i.postimg.cc/DZHD5Fh3/Gemini-Generated-Image-ktp6nektp6nektp6.png"
                    alt="Feature 2"
                    className="rounded-md w-full"
                  />
                </div>
            ...
            {/* --- NEWLY ADDED FULL-WIDTH SECTION --- */}
            <div className="bg-white/3 rounded-2xl p-8 shadow-xl">
              <h3 className="text-xl text-black font-bold">
                Crowd Management
              </h3>
              <p className="mt-2 mb-7 text-gray-900">
                Easily manage crowds with a lot of people using realtime digital signage connection.
              </p>
              <div className="mt-6 -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
