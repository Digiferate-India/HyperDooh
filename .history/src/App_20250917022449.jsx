...
// --- NEW: Loader Component matching the reference website ---
const Loader = ({ onLoaded }) => {
  ...
  useEffect(() => {
    ...
    // Initial animation for the loader content
    ...
    // Set up the exit animation but don't play it yet
    const exitTl = gsap.timeline({
      paused: true,
      onComplete: onLoaded, // Call the onLoaded function when done
    });
    ...
    const triggerExit = () => {
      setTimeout(() => {
        exitTl.play();
      }, 500); // A small delay after loading for the logo to be visible
    };

    // Attach the trigger function to the loader's ref so parent can call it
    if (loaderRef.current) {
      loaderRef.current.triggerExit = triggerExit;
    }
  }, [onLoaded]);
  ...
  return (
    ...
    >
      <div className="text-center">
        <h1
          ref={logoRef}
          className="text-[12vw] font-medium leading-none tracking-tighter sm:text-[10vw] md:text-[8vw] lg:text-[10rem]"
        ...
        <p
          ref={subtextRef}
          className="mt-2 text-xs font-light tracking-[0.2em] sm:text-sm"
          style={{ opacity: 0 }}
        >
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (loaderRef.current && loaderRef.current.triggerExit) {
        loaderRef.current.triggerExit();
      }
    }, 2500); // Adjust time as needed for loading simulation
  ...
  const handleLoad = () => {
    setLoading(false); // Update state to remove loader from DOM if needed
    
    // Animate the main content in
    gsap.to(mainRef.current, { autoAlpha: 1, duration: 0.5 });
    
    // Now, run all the main page animations
      ...
      >
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
              ...
              <div className="mt-10 grid grid-cols-2 items-center gap-x-8 gap-y-10 sm:grid-cols-3 lg:grid-cols-6">
                <span className="col-span-1 text-center text-2xl font-bold text-gray-400">
                  Zebra
                </span>
                <span className="col-span-1 text-center text-2xl font-bold text-gray-400">
                  Mondaze
        ...
        <div className="mt-20">
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8">
              <div className="feature-card rounded-2xl bg-white/3 p-8 shadow-xl">
                <h3 className="text-center text-xl font-bold text-black">
                  Signage Connection
                </h3>
                <p className="mb-7 mt-2 text-center text-gray-900">
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div className="feature-card rounded-2xl bg-white/3 p-8 text-center shadow-xl">
                  <h3 className="text-center text-xl font-bold text-black">
                    Lightning fast
                  </h3>
                  <p className="mb-7 mt-2 text-gray-900">
        ...
        <div className="py-24 sm:py-32">
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
              <div className="text-center">
                <span className="rounded-full bg-white/10 px-2.5 py-1 text-xs font-medium text-black">
                  PRICING
                </span>
              ...
              <div className="mt-16 grid grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:grid-cols-3">
                {/* Plan 1 */}
                <div className="relative rounded-3xl bg-white/5 p-8 shadow-xl ring-2 ring-indigo-500">
                  ...
                  <a
                    href="#"
                    className="mt-8 block rounded-md border-2 border-b-indigo-400 bg-black-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm"
                  >
                    Choose plan
                  </a>
                </div>
                ...
                {/* Plan 2 */}
                <div className="relative rounded-3xl bg-white/5 p-8 shadow-xl ring-1 ring-white/10 sm:mx-8 lg:mx-0">
                ...
                {/* Plan 3 */}
                <div className="relative rounded-3xl bg-white/5 p-8 shadow-xl ring-1 ring-white/10">
                  <h3 className="text-base font-semibold leading-7 text-black">
                    Enterprise
                  </h3>
                  <p className="mt-4 flex items-baseline gap-x-2">
        ...
        {/* Community Section */}
        <div id="community-section" className="py-16 text-center">
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
              <div className="mb-6 flex items-center justify-center">
                <div className="inline-flex items-center justify-center space-x-3 rounded-3xl bg-white-900/40 p-3 shadow-lg ring-1 ring-white/10">
                  <CommunityIconMail />
                  <CommunityIconFile />
                  <CommunityIconServer />
                </div>
              ...
              <div className="mt-8">
                <a
                  href="#"
                  className="inline-flex items-center gap-x-2 rounded-full border-2 bg-white px-6 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-200"
                >
                  Join Now
