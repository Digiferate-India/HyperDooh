import React, { useState, useEffect, useRef, forwardRef, useImperativeHandle } from "react";import { gsap } from "gsap";
import { ScrollTrigger } from "gsap/ScrollTrigger";

// --- Register GSAP Plugin ---
gsap.registerPlugin(ScrollTrigger);

// --- NEW: High-Fidelity Loader Component ---
const Loader = forwardRef(({ onLoaded }, ref) => {
  ...
  // Expose a trigger function to the parent component (App.js)
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden">
        ...
        {/* Subtext */}
        <p className="mt-2 text-center text-xs font-light tracking-[0.2em] sm:text-sm">
...
export default function App() {
  ...
  const handleLoad = () => {
    ...
    // Set loading to false a bit later to ensure it's removed after animations start
